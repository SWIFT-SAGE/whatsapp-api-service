    ...
    setTimeout(() => {
      ...
      if (qrPlaceholder) {
        qrPlaceholder.innerHTML = `
          <div class="qr-code" style="width: 200px; height: 200px; background: white; border: 2px solid #ddd; margin: 0 auto; display: flex; align-items: center; justify-content: center; border-radius: 8px;">
            <div style="width: 180px; height: 180px; background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" fill="%23000"/><rect x="10" y="10" width="20" height="20" fill="%23fff"/><rect x="70" y="10" width="20" height="20" fill="%23fff"/><rect x="10" y="70" width="20" height="20" fill="%23fff"/></svg>') center/contain no-repeat;"></div>
          </div>
          <p class="mt-2">Scan with WhatsApp to connect</p>
        `;
      }
    }, 500);
